...
// import BasicModalDialog from './addModal';
...
//     if(name !== ''){
//       try {
//         const response = await axios.post("http://localhost:5052/api/data", {
//             name,
...
//   try {
//     const response = await axios.delete(`http://localhost:5052/deleteAll`);
//     console.log(response.data);
//     // fetchData();
//   } catch (error) {
//     console.log(errConsole, error);
...
//                     <button onClick={(e) => {handleEdit(value.name);
//                     handleClick(index);}} className="button-68">Save</button>
//                   <button  className="button-45"  onClick={DeleteMotor} >Delete</button>
//                   </td>
//                   </>:<>
//                   <td>{index + 1}</td>
//                   <td></td>
...
//                      onClick={(e) => handleClick(index)}>Edit</button>
//                   <button className="button-45" onClick={DeleteMotor} >Delete</button></td>
//                   </>
//                   }
...
//            handleEdit={handleEdit}  setNewBrand={setNewBrand}
//            setNewName={setNewName} setNewCompany={setNewCompany}
//             setNewCost={setNewCost} setNewType={setNewType}
//             setNewDate={setNewDate} setNewPeople={setNewPeople}
//            />
//       </Box>
//     </MotoTable>
//   );
